  ...
  return (
    <React.Fragment>
      ...
      <div className="aboutUsspan">
        <span className="as1">
          ProfReview is a non-profit company which helps research students to
          find best faculty for their research work.
        </span>
      ...
      <div className="aboutUsLowerBody">
        ...
        <div className="aboutUsContent">
          <div className="aboutUsAshish">
            ...
            <ul>
              <li>
                <i class="fa fa-graduation-cap" aria-hidden="true"></i>IIIT
                KOTTAYAM
              </li>
            ...
            <div className="AshishInfo">
              <p>
                I have worked on Front End part and Authentication part of this
                website
              </p>
              <ul>
                <li>
      ...
      <div className="aboutUsLowerBody1">
        <div className="aboutUsContent1">
          <div className="aboutUsAshish">
            ...
            <div className="AshishInfo">
              <p>
                I have worked on Backend part and Authentication part of this
                website
              </p>
              <ul>
                <li>
